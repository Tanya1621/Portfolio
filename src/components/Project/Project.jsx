    ...
    return (
        <li className={style.project}>
            <div>
                ...
                <p className={style.project__technologies}>{project.technologies}</p>
                <p className={style.project__links}><a href={project.github}><img className={style.project__github_img}
                                                                                src={theme === 'dark' ? githubBlack : gitHubWhite}/></a> <a href={project.link}><img
                    className={style.project__github_img} src={theme === 'dark' ? link : linkLight}/></a></p>
